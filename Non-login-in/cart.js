...
function addEventToAllCartButtons() {
  ...
  shoppingCart.addEventListener("click", function () {
    alert("Bạn hãy đăng nhập để vào giỏ hàng");
  });
}

const shoppingCart_button = document.querySelector(".shopping_cart_button");
shoppingCart_button.addEventListener("click",function () {
  alert("Bạn hãy đăng nhập để vào giỏ hàng");
})
